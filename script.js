"use strict";
const quizBox_div = document.querySelector('.quiz-box');
const questionNumber_span = document.querySelector('.question-number');
const question_div = document.querySelector('.question');
const answers_inputs = document.querySelectorAll('.answers > input');
const answers_labels = document.querySelectorAll('.answers > label');
const btnPrev = document.querySelector('.buttons button:nth-child(1)');
const btnNext = document.querySelector('.buttons button:nth-child(2)');
const end_Div = document.querySelector('.quiz-end-box');
const score_span = document.querySelector('.quiz-end-box > h1');
const btnTryAgain = document.querySelector('.quiz-end-box > button');
let questionNumber = 0;
let answersPicked = Array.from(Array(10));
const quiz = [{
...
const countScore = () => {
    ...
    answersPicked.map((answerIndex, questionIndex) => {
        if (answerIndex !== undefined) {
            if (quiz[questionIndex].answers[answerIndex].correct)
                score++;
        }
    });
    return score;
